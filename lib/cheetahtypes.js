...
exports.MonthKdb = new (class MonthKdb extends KdbType {
  constructor() {
    super();
    this.size = 8;
    this.charType = 'z';
...
class DateTimeKdb extends KdbType {}
class TimespanKdb extends KdbType {}
class MinuteKdb extends KdbType {}
class SecondKdb extends KdbType {}
class TimeKdb extends KdbType {}

const d = new Date(2006, 5);
